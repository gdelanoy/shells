...
sudo -u guillaume DISPLAY=:0 DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus notify-send -t 90000 -i terminal "Filtrage web désactivé" "Access to brainspace-wasting sites is possilbe again. Enjoy your personal lobotomy ..."
